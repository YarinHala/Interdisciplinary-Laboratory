...
class ChartsPageTwo extends React.Component{
    constructor(props) {
    super(props);
    this.state = {
      dataBar:{},
  ...
  componentWillMount() {
    ...
    fetch('https://data-visualization-service.herokuapp.com/motionThrowYears/1989/1992')
  ...
  presidentChanged(bgColor,whoHasBeemClicked){
    ...
    this.chart2.current.handleChangeNav(bgColor,whoHasBeemClicked,1);

   fetch('https://data-visualization-service.herokuapp.com/motionThrowYears/'+array[0]+'/'+array[array.length-1])
    .then((Response)=>Response.json())
    .then((req)=>{
  ...
  handleChange(bgColor,presedentName){
     this.props.handleChange2(bgColor,presedentName);
  }

render() {
    return (
      <div>
      <PicturesNav ref={this.chart2} id="nav2" handleChange={this.handleChange.bind(this)} />
      <div id="charts">
